...
public class EmployeeDAO {
	...
	public void addEmployee(Employee theEmployee) throws Exception {
		...
		try {
			// prepare statement
			myStmt = myConn.prepareStatement("insert into employeessearch"
	...
	public List<Employee> getAllEmployees() throws Exception {
		...
		try {
			...
			myRs = myStmt.executeQuery("select * from employeessearch order by last_name");
	...
	public List<Employee> searchEmployees(String lastName) throws Exception {
		...
		try {
			lastName += "%";
			myStmt = myConn.prepareStatement("select * from employeessearch where last_name like ?  order by last_name");
